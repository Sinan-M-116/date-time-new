    ...
    try:
        while True:
            if Date_Time_Userbot_teletips.is_connected:
                ...
                Image_teletips = Image.open("Image-2.jpg")
                Image_font_teletips = ImageFont.truetype("ds-digit.ttf", 200)
                ...
                await Date_Time_Userbot_teletips.update_profile(bio = f"🖤 {Emojis_teletips} || 📅 {Date_teletips}" , last_name = f"| 🖤{Quotes_teletips} ")
