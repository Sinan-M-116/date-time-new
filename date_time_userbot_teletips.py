    ...
    try:
        while True:
            if Date_Time_Userbot_teletips.is_connected:
                ...
                Image_teletips = Image.open("Image.jpg","image-2.jpg")
                ...
                await Date_Time_Userbot_teletips.update_profile(bio = f"🖤 {Emojis_teletips} /n/n  {Time_teletips} | 📅 {Date_teletips}" , last_name = f"| 🖤{Quotes_teletips} ")
